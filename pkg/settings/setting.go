...
var (
	...
	NodeCreationGracePeriod         = NewSetting("machine-create-grace", "0")
	NodeDeletionTimeout             = NewSetting("machine-del-timeout", "0")
	...
	SelfHealingNodepools            = NewSetting("self-healing-nodepool", "true")
